...
us_atheist_prop <- us12 %>%
  summarise(prop_atheist = mean(response == "atheist"))
...
inference(y = response, data = brazil12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
...
inference(y = response, x = year, data = spain, statistic = "proportion", type = "ht", method = "theoretical", success = "atheist", alternative = "twosided")
...
# Given values
z_star <- 1.96  # Z-value for 95% confidence
ME <- 0.01      # Margin of error
p_hat <- 0.5    # Proportion (most conservative estimate)

n <- (z_star^2 * p_hat * (1 - p_hat)) / (ME^2)
n
