...
sample_means50_df <- data.frame(sample_mean = sample_means50)

ggplot(sample_means50_df, aes(x = sample_mean.x_bar)) +
...
sample_mean <- mean(price_sample$price)
sample_mean
```
...
```{r price-sampling}
# type your code for this Exercise here, and Run Document
sample_mean_function <- function(size) {
  mean(sample_n(ames, size = size, replace = TRUE)$price)
}
sample_means50 <- replicate(5000, sample_mean_function(50))
sample_means50_df <- data.frame(sample_mean = sample_means50)

ggplot(sample_means50_df, aes(x =sample_mean)) +
  geom_histogram(binwidth = 1000, fill = "blue", color = "black", alpha = 0.7) +
  labs(title = "Sampling Distribution of Sample Means (n = 50, replicates = 5000)",
       x = "Sample Mean",
       y = "Frequency") 
```
...
# type your code for this Exercise here, and Run Document
sample_means150 <- replicate(5000, sample_mean_function(150))
...
# type your code for this Exercise here, and Run Document
price_sample_small <- ames %>%
  sample_n(size = 15, replace = TRUE)

sample_mean_small <- mean(price_sample_small$price)
sample_mean_small
```
...
# type your code for this Exercise here, and Run Document
sample_means15 <- replicate(2000, sample_mean_function(15))

sample_means15_df <- data.frame(sample_mean = sample_means15)


ggplot(sample_means15_df, aes(x = sample_mean)) +
  geom_histogram(binwidth = 10000, fill = "blue", color = "black", alpha = 0.7) +
  labs(title = "Sampling Distribution of Sample Means (n = 15, replicates = 2000)",
       x = "Sample Mean",
       y = "Frequency")
...
# type your code for this Exercise here, and Run Document
sample_means150 <- replicate(2000, sample_mean_function(150))
